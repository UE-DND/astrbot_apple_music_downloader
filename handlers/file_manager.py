...
class FileManager:
    ...
    async def handle_clean_command(
        ...
        if is_force:
            ...
            download_dirs = self._plugin.docker_service.get_download_dirs()
            ...
            for d in download_dirs:
                ...
                success, msg, count = await self._plugin.docker_service.force_clean(d)
                if success:
                    success_count += 1
    ...
    async def _periodic_cleanup(self) -> None:
        ...
        while True:
            try:
                ...
                self._plugin._queue.cleanup_old_tasks()
            except asyncio.CancelledError:
